...
INSERT INTO product (p_id,p_name,p_description, p_price, p_stock, p_category, p_discount_perc) VALUES(8, 'Americano', 'Americano = Espresso + Water <br> Made with our signature freshly roasted expresso beans and distilled water.', 2.50,10,'brew',0);
INSERT INTO product (p_id,p_name,p_description, p_price, p_stock, p_category, p_discount_perc) VALUES(9, 'Espresso', 'Espresso = Americano - Water <br> Made with our signature freshly roasted expresso beans.', 2.50,2,'brew',0);
