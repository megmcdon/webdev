                        ...
                        <div class="row">
                                ...
                                <div class="blog-item">
                                    ...
                                    <div class="popup-wrapper">
                                        <div class="popup-gallery">
                                            <a href="${pageContext.request.contextPath}/images/Beans.jpg" class="popup3 blog-item-pic"><img src="${pageContext.request.contextPath}/images/Beans.jpg" class="width-100" alt="pic"><span class="eye-wrapper"><i class="fa fa-expand eye-icon"></i></span></a>
                                        </div>
                                    </div>
                                    <!--begin popup image -->
                            ...
                            <div class="col-md-4 wow bounceInUp">
                                ...
                                <div class="blog-item">
                                    ...
                                    <div class="popup-wrapper">
                                        <div class="popup-gallery">
                                            <a href="${pageContext.request.contextPath}/images/Brewing.jpg" class="popup3 blog-item-pic"><img src="${pageContext.request.contextPath}/images/Brewing.jpg" class="width-100" alt="pic"><span class="eye-wrapper"><i class="fa fa-expand eye-icon"></i></span></a>
                                        </div>
                                    </div>
                                    <!--begin popup image -->
                            ...
                            <div class="col-md-4 wow bounceInUp">
                                ...
                                <div class="blog-item">
                                    ...
                                    <div class="popup-wrapper">
                                        <div class="popup-gallery">
                                            <a href="${pageContext.request.contextPath}/images/Merchandise.jpg" class="popup3 blog-item-pic"><img src="${pageContext.request.contextPath}/images/Merchandise.jpg" class="width-100" alt="pic"><span class="eye-wrapper"><i class="fa fa-expand eye-icon"></i></span></a>
                                        </div>
                                    </div>
                                    <!--begin popup image -->
                    ...
                    <div class="container"> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 wow slideInRight">
                                ...
                                <img src="${pageContext.request.contextPath }/images/lg1.gif" alt="picture" class="width-100">
